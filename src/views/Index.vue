    ...
    <v-container fill-height >
        <v-row justify="center" align="center">
            <v-card class="card" :loading="isAjax">
                <v-img src="/banner.png" width="330" style="object-fit: contain" contain></v-img>
                <v-card-title>
                       <span>Fuji Subnet Faucet</span>
                </v-card-title>
                ...
                <v-card-text v-show="state==='form'">
                    <div>
                        ...
                        <qr-input v-model="address" placeholder="Subnetevm Chain Address"></qr-input>
                    </div>
